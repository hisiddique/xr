    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                ...
                <p class="body-text">
                    Please find attached the Supplier Purchasing report from
                ...
                <table class="summary-table">
                    <tr>
                        ...
                        <td class="summary-value">{{ $invoiceCount }}</td>
                    </tr>
                    <tr>
                        <td class="summary-label">Total Net</td>
                        <td class="summary-value">£{{ number_format($totalNet, 2) }}</td>
                    </tr>
                    <tr>
                        <td class="summary-label">Total VAT</td>
                        <td class="summary-value">£{{ number_format($totalVat, 2) }}</td>
                    </tr>
                    <tr class="summary-total">
                        <td class="summary-label">Total Gross</td>
                        <td class="summary-value">£{{ number_format($totalGross, 2) }}</td>
                    </tr>
                </table>
