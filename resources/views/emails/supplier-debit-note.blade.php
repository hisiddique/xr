...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                <p class="greeting">
                    Hi {{ $debitNote->supplier->first_name ?? $debitNote->supplier->company_name }},
                </p>

                <p class="body-text">
                    Please find attached debit note
                    <strong>{{ $debitNote->reference }}</strong>
                    raised by <strong>{{ \App\Models\Setting::get('company_name', config('app.name')) }}</strong>
                    against your account. A summary is included below for your reference.
                </p>

                {{-- Summary table --}}
                <table class="summary-table">
                    <tr>
                        <td class="summary-label">Debit Note Number</td>
                        <td class="summary-value" style="font-family:monospace">{{ $debitNote->reference }}</td>
                    </tr>
                    <tr>
                        <td class="summary-label">Date</td>
                        <td class="summary-value">{{ $debitNote->doc_date->format('d M Y') }}</td>
                    </tr>
                    <tr>
                        <td class="summary-label">Subtotal</td>
                        <td class="summary-value" style="font-family:monospace">£{{ number_format($debitNote->subtotal, 2) }}</td>
                    </tr>
                    <tr>
                        <td class="summary-label">VAT</td>
                        <td class="summary-value" style="font-family:monospace">£{{ number_format($debitNote->vat_amount, 2) }}</td>
                    </tr>
                    <tr class="summary-total">
                        <td class="summary-label">Total</td>
                        <td class="summary-value" style="font-family:monospace">£{{ number_format($debitNote->total, 2) }}</td>
                    </tr>
                </table>
                ...
                <p class="closing">
                    The debit note PDF is attached to this email for your records.
