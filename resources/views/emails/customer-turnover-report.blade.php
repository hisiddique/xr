...
<head>
    ...
    <title>Customer Turnover Report</title>
    <style>
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                ...
                <p class="body-text">
                    Please find attached the Customer Turnover report from
                ...
                <table class="summary-table">
                    ...
                    <tr class="summary-total">
                        <td class="summary-label">Total Turnover</td>
                        <td class="summary-value">£{{ number_format($totalTurnover, 2) }}</td>
                    </tr>
                </table>
